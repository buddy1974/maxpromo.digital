CREATE TYPE "public"."cta_type" AS ENUM('audit', 'call', 'contact');--> statement-breakpoint
...
CREATE TABLE "lead_submissions" (
	...
	"company" text,
	"message" text,
	"cta_type" "cta_type" DEFAULT 'audit' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "attribution" ADD CONSTRAINT "attribution_lead_id_lead_submissions_id_fk" FOREIGN KEY ("lead_id") REFERENCES "public"."lead_submissions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "referrals" ADD CONSTRAINT "referrals_lead_id_lead_submissions_id_fk" FOREIGN KEY ("lead_id") REFERENCES "public"."lead_submissions"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "lead_created_idx" ON "lead_submissions" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "lead_status_idx" ON "lead_submissions" USING btree ("status");--> statement-breakpoint
