 ...
 * failure on any of ten public domains rendered the framework's default: a
 * blank page reading "Application error: a client-side exception has occurred",
 * with nothing written down anywhere. The visitor saw nothing useful and the
 * platform learned nothing.
 *
