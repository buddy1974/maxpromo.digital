    ...
    return (
      <main style={{ background: 'var(--brand-background)', minHeight: '100vh', padding: 'var(--section-y-feature) var(--section-x) var(--section-y)' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          <p style={{ ...mono, fontSize: 'var(--text-micro)', color: 'var(--brand-text-secondary)', letterSpacing: '0.15em', textTransform: 'uppercase', margin: '0 0 16px' }}>
          ...
          <p style={{ ...sans, fontSize: 'var(--text-body)', color: 'var(--brand-text-secondary)', margin: '0 0 48px', maxWidth: '640px', lineHeight: 1.7 }}>
            {t(locale,
          ...
          <div style={{ display: 'grid', gap: '16px' }}>
            {PORTFOLIO.map((item, i) => (
              <article key={i} className="card">
                ...
                <p style={{ ...sans, fontSize: '16px', color: 'var(--brand-text-secondary)', margin: '0 0 16px', lineHeight: 1.65 }}>{item.summary}</p>
  ...
  return (
    <main style={{ background: 'var(--brand-background)', minHeight: '100vh', padding: 'var(--section-y-feature) var(--section-x) var(--section-y)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <form onSubmit={submit} style={{ width: '100%', maxWidth: '420px' }}>
        <p style={{ ...mono, fontSize: 'var(--text-micro)', color: 'var(--brand-text-secondary)', letterSpacing: '0.15em', textTransform: 'uppercase', margin: '0 0 16px', textAlign: 'center' }}>
        ...
        <p style={{ ...sans, fontSize: 'var(--text-small)', color: 'var(--brand-text-secondary)', margin: '0 0 32px', textAlign: 'center', lineHeight: 1.6 }}>
        ...
        />
        {error && (
          <p role="alert" style={{ ...mono, fontSize: 'var(--text-micro)', color: 'var(--semantic-danger)', margin: '12px 0 0' }}><Icon name="warning" size="xs" /> {error}</p>
        )}
        <button
          type="submit"
