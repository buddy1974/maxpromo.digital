  ...
  return (
    <main style={{ background: 'var(--brand-background)', minHeight: '100vh', paddingTop: 'var(--section-y)', paddingBottom: 'var(--section-y)' }}>
      <div style={{ maxWidth: 'var(--container)', margin: '0 auto', padding: '0 var(--space-6)' }}>
        ...
        {/* Header */}
        <div style={{ marginBottom: 'var(--space-10)', maxWidth: '640px' }}>
        ...
        {posts.length === 0 ? (
          <>
            <p style={{ fontFamily: 'var(--brand-font-mono)', fontSize: '12px', color: 'var(--brand-text-secondary)', letterSpacing: '0.08em', marginBottom: 'var(--space-6)' }}>
              {t('emptyTitle')}
            </p>
            <div
            ...
            >
              {placeholders.map((card, i) => (
                <article key={i} className="card" style={{ display: 'flex', flexDirection: 'column', opacity: 0.7, padding: 0 }}>
                  <div style={{ padding: '1.75rem', display: 'flex', flexDirection: 'column', gap: 'var(--space-3)', flex: 1 }}>
            ...
            {posts.map((post) => (
              ...
              >
                <article className="card mp-card-hover" style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden', padding: 0 }}>
                  ...
                  <div style={{ padding: 'var(--space-5)', display: 'flex', flexDirection: 'column', flex: 1, gap: '10px' }}>
                    {/* Tags */}
                    {post.tags.length > 0 && (
