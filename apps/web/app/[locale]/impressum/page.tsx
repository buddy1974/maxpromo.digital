      ...
      <div style={{ maxWidth: '56rem', margin: '0 auto', padding: '0 var(--space-5)' }}>
        ...
        <Section label="Beruf / Profession">
          <p style={{ margin: 0 }}>
            ...
            <span style={{ color: 'var(--brand-text-secondary)' }}>Software Developer and IT Consultant</span>
          </p>
        </Section>
        ...
        <Section label="Steuerliche Angaben / Tax Information">
          <p style={{ margin: 0 }}>
            ...
            <span style={{ color: 'var(--brand-text-secondary)' }}>VAT exempt per § 19 UStG (Kleinunternehmerregelung).</span>
          </p>
        </Section>
