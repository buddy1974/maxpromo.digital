  ...
  return `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:${token.surface};">
      ...
      <div style="padding:28px 32px;">
        <p style="color:${token.textSecondary};font-size:15px;line-height:1.7;margin:0 0 16px;">
          Hey${display},<br><br>
          You're now subscribed to <strong>Maxpromo Digital Weekly Automation Insights</strong>.<br>
          Real builds. Real results. Every week.
        </p>
        <p style="color:${token.textSecondary};font-size:13px;line-height:1.7;margin:0 0 24px;">
          You'll hear from us with practical automation tips, AI workflow breakdowns,
          and case studies from real client projects.
        </p>
        <a href="https://maxpromo.digital" style="display:inline-block;background:${token.primary};color:${token.surfaceInverted};font-family:monospace;font-weight:700;font-size:12px;letter-spacing:0.1em;padding:12px 24px;text-decoration:none;text-transform:uppercase;">
          Explore our work &rarr;
        </a>
      </div>
      <div style="background:${token.text};padding:16px 32px;">
        <p style="font-family:monospace;font-size:10px;color:${token.textMuted};margin:0;">
