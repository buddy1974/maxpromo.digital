...
const FEATURES = [
  ...
  { icon: '[ FAMILY ]', name: 'Families See Updates Online — Fewer Calls to Staff', desc: 'Daily updates, care plans, and medication schedules visible online. Fewer calls to staff. Better trust, less friction.' },
]
