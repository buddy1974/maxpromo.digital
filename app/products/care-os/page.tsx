...
const FLOW = [
  { step: '01', label: 'Staff logs care note' },
  { step: '02', label: 'Medication administered and recorded' },
  { step: '03', label: 'Incident flagged if needed' },
  { step: '04', label: 'Manager notified' },
  { step: '05', label: 'CQC audit trail complete' },
]
        ...
        <section style={{ padding: '5rem 2rem', borderBottom: '1px solid #1A1A1A' }}>
          <div style={{ maxWidth: '72rem', margin: '0 auto' }}>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '18px', color: '#666666', maxWidth: '600px', lineHeight: 1.8, whiteSpace: 'pre-line' }}>
              CareOS replaces paper care plans, scattered training records, and WhatsApp rota groups.
              Digital care plans, medication records, staff scheduling, compliance tracking, and AI automation — all connected.
              This system is now available for selected clients.
            </p>
        ...
        <section style={{ background: '#0F0F0F', padding: '4rem 2rem', borderTop: '1px solid #1A1A1A', borderBottom: '1px solid #1A1A1A' }}>
          <div style={{ maxWidth: '72rem', margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: 'var(--font-heading)', fontWeight: 700, fontSize: '22px', color: '#F0F0F0', letterSpacing: '-0.03em', marginBottom: '2rem' }}>
              From daily care note to full audit trail.
            </h2>
