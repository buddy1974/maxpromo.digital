...
const CATEGORIES = [
  {
    ...
    automations: [
      ...
      { title: 'Contract Review Agent', description: 'Reads contracts, extracts key clauses, flags non-standard terms, and produces a structured summary for legal or commercial review.', tools: ['Claude AI', 'Google Drive', 'Notion', 'Slack'] },
      { title: 'Research & Briefing Agent', description: 'Given a topic or company, autonomously researches multiple sources, synthesises findings, and delivers a structured briefing document in minutes.', tools: ['Claude AI', 'Notion', 'Resend', 'n8n'] },
      { title: 'Proposal Generation Agent', description: 'Takes a client brief and drafts a formatted proposal including scope, timeline, and pricing — ready for human review and send.', tools: ['Claude AI', 'HubSpot', 'Google Docs', 'Make'] },
      { title: 'Internal Knowledge Assistant', description: 'AI assistant trained on your internal docs, SOPs, and policies. Staff ask questions in plain English and get accurate answers instantly.', tools: ['Claude AI', 'Notion', 'Confluence', 'Slack'] },
    ],
  },
  {
    ...
    automations: [
      ...
      { title: 'Meeting Summarisation Workflow', description: 'Transcribes meetings, extracts decisions and action items, sends structured summaries, and creates tasks in your project management tool.', tools: ['Whisper AI', 'Notion', 'Slack', 'n8n'] },
      { title: 'Employee Onboarding Automation', description: 'Triggers a full onboarding sequence on new hire creation — provisioning, welcome emails, document requests, training assignments, manager notifications.', tools: ['BambooHR', 'Slack', 'Google Workspace', 'Make'] },
      { title: 'Reporting & Analytics Pipeline', description: 'Pulls data from multiple sources on a schedule, applies formatting rules, and distributes finished reports to stakeholders automatically.', tools: ['Supabase', 'Google Sheets', 'Claude AI', 'Resend'] },
      { title: 'Appointment Booking Automation', description: 'Lets prospects book calls from your site, checks availability, sends confirmations, adds to CRM, and triggers pre-call preparation sequences.', tools: ['Calendly', 'HubSpot', 'Make', 'Gmail'] },
    ],
  },
  {
    ...
    automations: [
      ...
      { title: 'Email Marketing Automation', description: 'Behaviour-triggered email sequences that adapt based on recipient actions. Welcome flows, nurture sequences, re-engagement campaigns — personalised by Claude.', tools: ['Claude AI', 'Mailchimp', 'HubSpot', 'Make'] },
      { title: 'Brand Monitoring & Response Agent', description: 'Monitors mentions across social platforms and review sites, classifies sentiment, drafts response suggestions, and alerts the team to high-priority mentions.', tools: ['Claude AI', 'Airtable', 'Slack', 'n8n'] },
      { title: 'Video & Content Repurposing', description: 'Takes a video transcript or blog post and repurposes it into LinkedIn posts, X threads, email newsletters, and short-form scripts.', tools: ['Claude AI', 'Notion', 'Buffer', 'Make'] },
      { title: 'Product Description AI', description: 'Generates SEO-optimised product descriptions in your brand voice at scale. Input product data, output publish-ready copy for every SKU in your catalogue.', tools: ['Claude AI', 'Shopify', 'Airtable', 'Make'] },
    ],
  },
]
