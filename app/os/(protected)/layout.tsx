      ...
      {aiOpen && (
        <div style={{
          ...
          <div style={{ padding: '16px 20px', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div>
              <p style={{ fontFamily: sans, fontWeight: 700, fontSize: '14px', color: '#FFFFFF', margin: 0 }}>{t.ai.title}</p>
              <p style={{ fontFamily: mono, fontSize: '9px', color: '#444444', letterSpacing: '0.18em', margin: '3px 0 0' }}>{t.ai.subtitle}</p>
            </div>
          ...
          {msgs.length === 0 && (
            <div style={{ padding: '14px 20px', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
              <p style={{ fontFamily: mono, fontSize: '9px', color: '#444444', letterSpacing: '0.18em', textTransform: 'uppercase', margin: '0 0 10px' }}>{t.ai.quickPrompts}</p>
            ...
            <div style={{ padding: '20px' }}>
              ...
              {qsSaved && (
                <div style={{ textAlign: 'center', padding: '20px 0' }}>
                  <p style={{ fontFamily: mono, fontSize: '14px', color: '#22c55e', margin: '0 0 6px' }}>{t.quickScan.savedHeading}</p>
