...
const ROUTES: Array<{ path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]['changeFrequency'] }> = [
  ...
  { path: '/products/restaurant-os',       priority: 0.7, changeFrequency: 'monthly' },
  { path: '/products/taxkontrol',          priority: 0.7, changeFrequency: 'monthly' },
  { path: '/products/handwerk-os',         priority: 0.7, changeFrequency: 'monthly' },
  { path: '/products/praxis-os',           priority: 0.7, changeFrequency: 'monthly' },
  { path: '/products/printshop',           priority: 0.7, changeFrequency: 'monthly' },
  { path: '/products/publishing-os',       priority: 0.7, changeFrequency: 'monthly' },
  ...
  { path: '/automation-audit',             priority: 0.7, changeFrequency: 'monthly' },
  { path: '/automation-lab',               priority: 0.5, changeFrequency: 'monthly' },
  { path: '/discovery',                    priority: 0.6, changeFrequency: 'monthly' },
