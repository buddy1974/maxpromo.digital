...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://www.maxpromo.digital/${locale}/products/printshop`,
      languages: {
        de: 'https://www.maxpromo.digital/de/products/printshop',
        en: 'https://www.maxpromo.digital/en/products/printshop',
      },
    },
    openGraph: {
      title,
      description,
      url: `https://www.maxpromo.digital/${locale}/products/printshop`,
    },
  }
}
    ...
    <>
      ...
      <main style={{ background: '#FFFFFF' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center', marginBottom: '2rem' }}>
              <a href="#walkthrough"
                ...
                {locale === 'de' ? 'Walkthrough anfragen →' : 'Request walkthrough →'}
              </a>
              <Link href="/contact?system=printshop-os"
                ...
                {locale === 'de' ? 'Gespräch anfragen →' : 'Talk with us →'}
              </Link>
            </div>
        ...
        <ConnectedSystems systems={[
          { slug: 'taxkontrol',   name: 'TaxKontrol',   description: locale === 'de' ? 'Rücklagen und finanzielle Verpflichtungen im Blick.' : 'Keep reserves and financial obligations visible.', href: '/products/taxkontrol'   },
          { slug: 'handwerk-os', name: 'HandwerkOS',   description: locale === 'de' ? 'Produktion und Feldbetrieb verbinden.' : 'Connect production and field operations.',         href: '/products/handwerk-os'  },
          { slug: 'publishing-os', name: 'PublishingOS', description: locale === 'de' ? 'Produktions- und Distributionsabläufe verwalten.' : 'Manage production and distribution workflows.',   href: '/products/publishing-os'},
        ]} locale={locale} />
