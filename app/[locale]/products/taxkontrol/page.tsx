...
export default async function TaxKontrolPage({
  ...
  const connectedSystems = locale === 'de'
    ? [
        { slug: 'restaurant-os', name: 'RestaurantOS', description: 'Betriebliche Aktivität und Umsatzfluss sehen.',    href: '/products/restaurant-os' },
        { slug: 'handwerk-os',   name: 'HandwerkOS',   description: 'Aufträge und Rechnungsbewegung verfolgen.',        href: '/products/handwerk-os'   },
        { slug: 'printshop-os',  name: 'PrintShopOS',  description: 'Produktion und Finanzen im Blick behalten.',      href: '/products/printshop-os'  },
      ]
    : [
        ...
        { slug: 'printshop-os',  name: 'PrintShopOS',  description: 'Keep production and finance visible.',            href: '/products/printshop-os'  },
      ]
          ...
          <div style={{ maxWidth: '72rem', margin: '0 auto' }} className="tk-hero">
            <div>
              ...
              <div className="mp-hero-4" style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center' }}>
                ...
                >
                  {t(locale, 'Vorführung anfragen →', 'Request walkthrough →')}
                </a>
                <a
                  href="#workflow"
                ...
                >
                  {t(locale, 'So funktioniert es →', 'See how it works →')}
                </a>
              </div>
