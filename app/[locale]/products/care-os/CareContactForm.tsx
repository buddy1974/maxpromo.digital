...
export function CareContactForm({ locale }: { locale: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ maxWidth: '480px', display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '2.5rem' }}>
      {([
        ...
        { field: 'organisation', type: 'text',  labelEn: 'Organisation name', labelDe: 'Name der Organisation',  required: true  },
