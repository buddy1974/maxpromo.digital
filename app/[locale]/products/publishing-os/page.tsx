...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://www.maxpromo.digital/${locale}/products/publishing-os`,
      languages: {
        de: 'https://www.maxpromo.digital/de/products/publishing-os',
        en: 'https://www.maxpromo.digital/en/products/publishing-os',
      },
    },
    openGraph: {
      title,
      description,
      url: `https://www.maxpromo.digital/${locale}/products/publishing-os`,
    },
  }
}
    ...
    <>
      ...
      <main style={{ background: BG }}>
        ...
        <ConnectedSystems systems={[
          { slug: 'printshop-os',  name: 'PrintShopOS', description: locale === 'de' ? 'Produktionsworkflow-Abstimmung.' : 'Production workflow alignment.',  href: '/products/printshop'    },
          { slug: 'taxkontrol',    name: 'TaxKontrol',  description: locale === 'de' ? 'Geschäftsübersicht.' : 'Business visibility.',            href: '/products/taxkontrol'   },
