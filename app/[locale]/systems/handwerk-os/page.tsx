...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://www.maxpromo.digital/${locale}/systems/handwerk-os`,
      languages: {
        de: 'https://www.maxpromo.digital/de/systems/handwerk-os',
        en: 'https://www.maxpromo.digital/en/systems/handwerk-os',
      },
    },
    openGraph: {
      title,
      description,
      url: `https://www.maxpromo.digital/${locale}/systems/handwerk-os`,
    },
  }
}
...
const STYLES = `
  ...
  .hw-cta-primary   { transition: background 150ms ease; }
  .hw-cta-primary:hover   { background: #EA6A00 !important; }
  .hw-cta-secondary { transition: border-color 150ms ease; }
  .hw-cta-secondary:hover { border-color: #333 !important; }
`
    ...
    <>
      ...
      <main style={{ background: BG }}>
        ...
        <section style={{ padding: '5rem 2rem', borderBottom: `1px solid ${BORDER}` }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center' }}>
              <a href="https://superhandwerk.de" target="_blank" rel="noopener noreferrer" className="hw-cta-primary"
              ...
              <Link href="/contact?system=handwerk-os" className="hw-cta-secondary"
        ...
        <ConnectedSystems systems={[
          { slug: 'taxkontrol', name: 'TaxKontrol', description: locale === 'de' ? 'Kosten und Pflichten verstehen.' : 'Understand costs and obligations.',              href: '/systems/taxkontrol' },
          { slug: 'praxis-os',  name: 'PraxisOS',   description: locale === 'de' ? 'Inspiration für Termin- und Verwaltungsabläufe.' : 'Appointment and admin workflow inspiration.',   href: '/systems/praxis-os'  },
