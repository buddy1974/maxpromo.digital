...
export function PraxisContactForm({ locale }: { locale: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ maxWidth: '480px', display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '2.5rem' }}>
      {([
        ...
        { field: 'practice',  type: 'text',  labelEn: 'Practice name',     labelDe: 'Praxisname',      required: true  },
        { field: 'specialty', type: 'text',  labelEn: 'Medical specialty', labelDe: 'Fachgebiet',      required: true  },
