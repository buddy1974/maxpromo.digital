...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://www.maxpromo.digital/${locale}/systems/praxis-os`,
      languages: {
        de: 'https://www.maxpromo.digital/de/systems/praxis-os',
        en: 'https://www.maxpromo.digital/en/systems/praxis-os',
      },
    },
    openGraph: {
      title,
      description,
      url: `https://www.maxpromo.digital/${locale}/systems/praxis-os`,
    },
  }
}
...
const STYLES = `
  ...
  .px-cta-primary   { transition: background 150ms ease; }
  .px-cta-primary:hover   { background: #EA6A00 !important; }
  .px-cta-secondary { transition: border-color 150ms ease; }
  .px-cta-secondary:hover { border-color: #333 !important; }
`
        ...
        <section style={{ padding: '5rem 2rem', borderBottom: `1px solid ${BORDER}` }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', alignItems: 'center' }}>
              <a href="https://super-praxis.de" target="_blank" rel="noopener noreferrer" className="px-cta-primary"
              ...
              <Link href="/contact?system=praxis-os" className="px-cta-secondary"
