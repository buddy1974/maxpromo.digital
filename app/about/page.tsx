...
const STACK_ROWS = [
  { label: '// AI & AUTOMATION', tools: ['Claude AI', 'OpenAI', 'n8n', 'Make', 'Zapier', 'LangChain', 'Airtable'] },
  { label: '// INFRASTRUCTURE', tools: ['Supabase', 'Neon', 'Vercel', 'Render', 'Next.js', 'Cloudflare', 'Resend', 'Twilio'] },
  { label: '// INTEGRATIONS', tools: ['HubSpot', 'Notion', 'Slack', 'Xero', 'Google Workspace', 'Shopify', 'Zendesk'] },
]

const VALUES = [
  { num: '01', title: 'Results before aesthetics', desc: 'Every system we build is measured by what it saves or earns — not how impressive the architecture looks on a diagram.' },
  { num: '02', title: 'Minimum viable complexity', desc: 'The simplest automation that solves the problem is always the right automation. We resist over-engineering by default.' },
  { num: '03', title: 'Production-first mindset', desc: 'We build for live systems from day one. Staging environments, error handling, monitoring — not an afterthought.' },
  { num: '04', title: 'Transparent delivery', desc: 'Fixed-price scopes, clear milestones, and no surprises. You know exactly what you are getting before we write a line of code.' },
]
