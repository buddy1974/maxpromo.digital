        ...
        <div style={{ display: 'grid', gap: '12px' }} className="grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {seeInAction.map((tab, i) => (
            <div key={i} style={{ padding: '1.5rem', border: CARD_BORDER, borderRadius: RADIUS.md }}>
              <p style={{ fontFamily: 'var(--brand-font-sans)', fontSize: '10px', color: 'var(--brand-accent)', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '8px' }}>
                {tab.tab}
              </p>
              <p style={{ fontFamily: 'var(--font-heading)', fontWeight: 600, fontSize: '15px', color: 'var(--brand-fg)', margin: '0 0 6px', lineHeight: 1.35 }}>
                {tab.headline}
              </p>
